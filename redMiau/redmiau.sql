...
--
-- Servidor: localhost
-- Tiempo de generación: 14-08-2019 a las 01:31:11
...
--
-- Volcado de datos para la tabla `sigin`
--

INSERT INTO `sigin` (`idReg`, `Name`, `LastName`, `Email`, `Password`, `Username`, `NumPhone`, `Occupation`, `AccepTerm`) VALUES
(1, 'paco', 'perez', 'apd44876@zwoho.com', '12345', 'paco1', '3213131232', 'Student', 'on');
...
--
ALTER TABLE `public`
  MODIFY `idPublic` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `sigin`
--
ALTER TABLE `sigin`
  MODIFY `idReg` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
