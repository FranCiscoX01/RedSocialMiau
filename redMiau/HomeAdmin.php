...
<html lang="en" dir="ltr">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var refreshId = setInterval(function() {
        $("#PublicationsAdmin").load('PublicationsAdmin.php');
      }, 500);
    });
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link active" href="HomeAdmin.php">
          ...
          <a class="nav-item nav-link" href="Stadistics.php">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data"><!------------form------>
            ...
            <div class="custom-file">
              <input type="text" id="userpost" name="userpost" value="ADMIN" hidden>
            </div>
            <br>
            <br>
          ...
          <?php
            if (isset($_POST['ppost']) && $_POST['ppost'] == "PublicPost" && ($_POST['posttext'] != "" || $_FILES['upfile']['name'] != "")) {
              ...
              if (move_uploaded_file($_FILES['upfile']['tmp_name'], $upload)) {
                if ($imgP || $audP || $vidP) {
                  echo "<script> swal('Successful post!', 'You clicked the button!', 'success').then((value) => { window.location='HomeAdmin.php'; }); </script>";
                } else {
                  echo "<script> swal('Post Fail!', 'You clicked the button!', 'error').then((value) => { window.location='HomeAdmin.php'; }); </script>";
                }
              } elseif ($_POST['posttext'] != "" && $_FILES['upfile']['tmp_name'] == "") {
                echo "<script> swal('Successful post!', 'You clicked the button!', 'success').then((value) => { window.location='HomeAdmin.php'; }); </script>";
              } else {
                echo "<script> swal('Upload File Fail!', 'You clicked the button!', 'error').then((value) => { window.location='HomeAdmin.php'; }); </script>";
              }
            }
          ?>
        </div>
    ...
    <div class="container" id="PublicationsAdmin">
